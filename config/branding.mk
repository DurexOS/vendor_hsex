...
HEAVENS_BUILD_VERSION := 3.0
HEAVENS_CODENAME := Seimei
...
HEAVENS_VERSION := Heavens-Experience-$(HEAVENS_BUILD_VERSION)-$(HEAVENS_BUILD_TYPE)-$(HEAVENS_BUILD)-$(HEAVENS_VARIANT)-$(HEAVENS_DEVICE)-$(HEAVENS_BUILD_DATE)
HEAVENS_BUILD_FINGERPRINT := Heavens-Experience/$(HEAVENS_VERSION)/$(TARGET_PRODUCT_SHORT)/$(HEAVENS_BUILD_DATE)

PRODUCT_GENERIC_PROPERTIES += \
  ro.heavens.device=$(HEAVENS_DEVICE) \
